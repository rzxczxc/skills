...
1. If you give a task an overly long timeline, people tend to use all of it (or procrastinate until the last minute), so the task takes as long as the deadline allows.
2. Giving more time, teams often do polishing (gold-plating) or add minor improvements that aren't strictly necessary, just to use the whole time allotted for the task.
3. A bit stronger (but realistic) deadlines can counteract Parkinson's Law by having a sense of urgency (called deadline-driven development).
...
- [Parkinson's Law (Original Essay)](https://www.economist.com/news/1955/11/19/parkinsons-law) — Cyril Parkinson's original 1955 essay in The Economist
- [Parkinson's Law: The Book](https://amzn.to/4jg0OOD) — The expanded book version of Parkinson's observations on bureaucracy and time
- [Parkinson's Law - Wikipedia](https://en.wikipedia.org/wiki/Parkinson%27s_law) — Overview of Parkinson's Law and its applications in management

---

Citation: "Parkinson's Law" from *Laws of Software Engineering* by Dr. Milan Milanović
Canonical URL: https://lawsofsoftwareengineering.com/laws/parkinsons-law/

...
1. A small fraction of people often contribute a significant fraction of the results. In a 100-person engineering org, about 10 people might produce half of the output.
2. As teams grow, productive output doesn't scale linearly. Adding more people increases total output, but many will make smaller contributions than the core group.

...
1. Dunbar's number (~150) is the size of a community in which everyone knows each other's identities and roles. Beyond this, our brains struggle to track relationships.
2. In software organizations, teams larger than ~100-150 will require more hierarchy or splitting into subgroups to function effectively. Coordination overhead rises sharply.

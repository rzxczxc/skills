...
1. There is often a gap between deep technical understanding and management roles. Rarely does one person excel at both.
2. Technical experts often aren't in management, and managers usually don't understand the technical details.
3. This can lead to unrealistic expectations, such as when management sets unrealistic expectations because they don’t understand the domain and its complexity. At the same time, engineers are feeling misunderstood.
4. Successful organizations bridge this by training managers in tech basics or promoting technically savvy leaders.
...
- [Putt's Law and the Successful Technocrat - Amazon](https://amzn.to/4aAuOm0) — The original satirical book by Archibald Putt
- [The Boeing 737 MAX: Lessons for Engineering Ethics](https://doi.org/10.1007/s11948-020-00252-y) — Herkert, Borenstein & Miller (2020) - examines how management decisions overriding technical expertise led to disaster

---

Citation: "Putt's Law" from *Laws of Software Engineering* by Dr. Milan Milanović
Canonical URL: https://lawsofsoftwareengineering.com/laws/putts-law/
